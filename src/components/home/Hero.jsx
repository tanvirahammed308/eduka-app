...
const Hero = () => {
  ...
  const images = [
    {
      ...
      description: "Education is the foundation of a better future. At our institution, we provide quality learning experiences that inspire curiosity, creativity, and critical thinking",
    },
    {
  ...
  return (
    <div className="relative w-full md:mb-52 ">
      <Swiper
      ...
      >
        {images.map((img, index) => (
          <SwiperSlide key={index}>
            <div className="relative w-full lg:h-[50vh] xl:h-[500px] ">
              <img
                src={img.src}
                alt={`Slide ${index}`}
